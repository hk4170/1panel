...
TXT_SET_INSTALL_DIR="设置 1Panel 安装目录 (默认为 /opt): "
...
TXT_DOCKER_INSTALL_FAIL="Docker 安装失败\n您可以尝试使用离线包安装 Docker，详细安装步骤请参见以下链接: https://1panel.cn/docs/installation/package_installation/"
...
TXT_SET_PANEL_PORT="设置 1Panel 端口 (默认是"
